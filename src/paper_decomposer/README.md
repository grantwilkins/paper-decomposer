...
| [`db/client.py`](db/client.py) | `PaperDecomposerDB` — async psycopg connection pool. `apply_schema()` is implemented; transaction helpers are stubs for the live DB writer. |
